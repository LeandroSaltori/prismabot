...
4. **Copie o Token** gerado (ele será usado no Painel de Configuração).
...
#### Parte 2: Configuração no Painel de Configuração

Com os dados em mãos, vamos configurar o aplicativo dentro do sistema.

1. Acesse o painel **Painel de Configuração** > **App Waba**.
...
5. Salve o cadastro no Painel de Configuração.
