...
* Antes de iniciar **qualquer** procedimento, crie um **ponto de restauração (snapshot)** completo do seu servidor servidor. Alterações incorretas podem comprometer o funcionamento da sua plataforma.
* Todas as alterações devem ser feitas logado na servidor com o usuário `deployzdg`. **Não realize os procedimentos se estiver logado como** `root`.
...
[AnteriorComo liberar espaço em disco na servidor do Prismabot](/avancado-recursos-tecnicos/como-liberar-espaco-em-disco-na-servidor-do-prismabot)[PróximoIntegrando o chat GPT](/avancado-recursos-tecnicos/integrando-o-chat-gpt)
