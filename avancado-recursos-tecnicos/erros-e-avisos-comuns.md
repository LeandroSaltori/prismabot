...
**Onde aparece:** na tela de login, ao tentar entrar com o Painel Administrativo.

**O que significa:** a licença expirou ou ficou inválida. O sistema entra automaticamente em **modo de recuperação**, onde somente o Painel Administrativo consegue alterar a chave de licença.

**Como resolver:**

1. Acesse com o **Painel Administrativo**
...
Se o sistema ficar mais de **6 horas** com a licença inválida, ele bloqueia o acesso. Nesse caso, além de inserir a chave válida, é necessário reiniciar o backend. Somente o **Painel Administrativo** pode alterar a chave de licença nesse estado.

#### Esta empresa está inativa. Entre em contato com o administrador

* **Situação:** Tenta logar pelo Painel Administrativo e o aviso aparece
...
**Como resolver:** acesse o **Painel Administrativo → Tenants** e revise o limite de conexões configurado para esse tenant. Aumente o limite se necessário.
...
Acessar a servidor como deploy
