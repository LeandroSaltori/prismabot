...
🎨 [Personalizações](../../configuracao-administrador/visao-geral-admin de atendimento.md)
☁️ Armazenamento externo ([Storage AmazonS3](../../configuracao-administrador/visao-geral-admin.md), etc)
