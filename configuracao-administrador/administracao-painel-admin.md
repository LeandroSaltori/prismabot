...
A seção de **Administração** concentra as configurações estruturais da operação: os canais de comunicação conectados, as equipes de atendimento e os usuários com seus níveis de acesso. São as configurações que definem como o sistema recebe mensagens, quem atende e como o acesso é organizado.
...
* WhatsApp Oficial — App ZDG (OAuth) — conexão via app da ZDG com coexistência, sem configuração de app próprio
* Configurar App Próprio no Facebook Developers — para quem quer white-label ou isolamento de reputação
* Dialog360 — BSP e Gupshup — BSP — conexão via Business Solution Provider

**WhatsApp não oficial**

* Baileys, wwebjs, Evolution API, Meow / WuzAPI, UAZAPI, Z-API

**Redes sociais e outros canais**

* Instagram e Facebook Messenger, Telegram, TikTok, YouTube, LinkedIn

**E-mail e Webchat**

* Webchat, E-mail IMAP/SMTP, Webmail Gmail
