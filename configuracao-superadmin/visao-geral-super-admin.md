...
O **Painel Superadmin** é a área administrativa de mais alto nível do Prismabot. É aqui que o dono da instalação gerencia a infraestrutura, as licenças, a personalização Prismabot, os tenants (empresas clientes) e as conexões globais que alimentam toda a plataforma.

Este painel é exclusivo para o **dono da instalação** (dono da servidor ou do SaaS). Não deve ser confundido com o painel de atendimento nem com o painel Admin de cada tenant.
...
* **Customizar (Prismabot)** — nome, cor, logo e domínio da plataforma
