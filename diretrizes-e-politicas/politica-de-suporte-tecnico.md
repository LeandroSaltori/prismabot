...
* Dúvidas sobre o funcionamento e os recursos do sistema Prismabot.
* Investigação e correção de bugs ou falhas na plataforma.
* Auxílio via helpdesk em configurações relacionadas às funcionalidades nativas do Prismabot.
...
O Prismabot oferece integração com diversas ferramentas externas, mas o funcionamento, a configuração e o suporte de cada uma são de responsabilidade do respectivo fornecedor. Não prestamos suporte para:
...
* Números bloqueados ou banidos pela Meta — banimentos são aplicados pela própria Meta com base no comportamento de uso e não têm relação com o Prismabot.
