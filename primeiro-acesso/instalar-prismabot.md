...
### [3. Ativar Licença Prismabot](/configuracao-superadmin/tenants-e-licenca/gerenciar-licenca-prismabot)

Após a instalação, a licença precisa ser ativada pelo superadministrador. Esta página cobre como validar a chave de licença pela primeira vez, visualizar o status da assinatura e realizar a renovação quando necessário.

[AnteriorOnboarding - novos assinantes](/primeiro-acesso/onboarding-novos-assinantes)[Próximo1. Preparar ambiente](/primeiro-acesso/instalar-prismabot/1.-preparar-ambiente)
